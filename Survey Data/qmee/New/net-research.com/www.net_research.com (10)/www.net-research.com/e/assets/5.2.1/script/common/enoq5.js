  ...
  var enoq5 = {
    toTargetSelector: function (qExExpr, opt_itemId) {
      ...
      for (var i = 0; i < selections.length; i++) {
        if (opt_itemId === undefined) {
          ...
          selectors.push(
            "#q" + qExExpr.qId + "_" + opt_itemId + "_" + selections[i]
          );
        }
      }
    ...
    joinConditionTable: function (
      ...
      $(baseSelector)
        .find("thead > tr")
        .append(
          "<th class='condition-random' colspan='" +
            oppositeColumnSize +
            "'>" +
            randomHeaderText +
            "</th>"
      ...
      $(baseSelector)
        .find("td.captionGroupTableCell.shuffle")
        .each(function (i, td) {
          $(td).hover(
            function (e) {
              var dfd = $.Deferred();
              ...
              setTimeout(function () {
                ...
                var endRow =
                  typeof rowspan !== "undefined"
                    ? startRow + parseInt(rowspan)
                    : startRow;
                var $highlightRange = $target
                  .closest("tbody")
                  .find("tr")
