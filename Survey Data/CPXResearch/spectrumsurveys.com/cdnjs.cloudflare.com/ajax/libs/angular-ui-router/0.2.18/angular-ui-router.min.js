...
"undefined" != typeof module &&
  ...
  (function (a, b, c) {
    ...
    function t() {
      function a(a) {
        return null != a
          ? a.toString().replace(/~/g, "~~").replace(/\//g, "~2F")
          : a;
      }
      function e(a) {
        return null != a
          ? a.toString().replace(/~2F/g, "/").replace(/~~/g, "~")
          : a;
      }
      function f() {
      ...
      (t.$$getDefaultValue = function (a) {
        ...
        (this.Param = function (a, d, e, f) {
          ...
          function r(a, b, d, e) {
            ...
            return (
              (f = P(a.replace) ? a.replace : []),
              N(e) && f.push({ from: e, to: c }),
              (g = o(f, function (a) {
                return a.from;
              })),
              n(i, function (a) {
        ...
        return (
          ...
          (y.go = function (a, b, c) {
            return y.transitionTo(
              a,
              b,
              R({ inherit: !0, relative: y.$current }, c)
            );
          }),
              ...
              function () {
                ...
                return y.transition !== M
                  ...
                  : ((y.$current = b),
                    ...
                    f.notify &&
                      a.$broadcast("$stateChangeSuccess", b.self, c, j.self, l),
                    p.update(!0),
                    y.current);
              },
              function (d) {
        ...
        C = {
          ...
          params: function (a) {
            ...
            return a.parent && a.parent.params
              ? R(a.parent.params.$$new(), b)
              : new U.ParamSet();
          },
          views: function (a) {
            var b = {};
            return (
              Q(L(a.views) ? a.views : { "": a }, function (c, d) {
        ...
        controller: [
          ...
          function (b, d, e, f) {
            function g(b, c, e) {
              var f = a.get(b, C(d)),
                g = h(b, c);
              p.push({ state: f || { name: b }, params: c, hash: g }),
                (q[g] = e);
            }
            function h(a, c) {
      ...
      (r.prototype.format = function (a) {
        ...
        for (f = 0; i > f; f++) {
          ...
          if (k) {
            ...
            if (q === !1)
              null != r &&
                (j += P(r) ? o(r, b).join("-") : encodeURIComponent(r)),
                (j += s);
            else if (q === !0) {
              var u = j.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
              j += s.match(u)[1];
    ...
    (y.$inject = ["$state", "$injector", "$uiViewScroll", "$interpolate"]),
      ...
      b
        .module("ui.router.state")
        .directive("uiSref", G)
        .directive("uiSrefActive", I)
        .directive("uiSrefActiveEq", I)
        .directive("uiState", H),
      (J.$inject = ["$state"]),
      (K.$inject = ["$state"]),
      b
