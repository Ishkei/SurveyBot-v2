!(function (e, t) {
  ...
  function o(e) {
    var t = (ve[e] = {});
    return (
      oe.each(e.match(ge) || [], function (e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function a() {
    fe.addEventListener
      ? (fe.removeEventListener("DOMContentLoaded", s, !1),
        e.removeEventListener("load", s, !1))
      : (fe.detachEvent("onreadystatechange", s), e.detachEvent("onload", s));
  }
  function s() {
    (fe.addEventListener ||
      "load" === event.type ||
  ...
  function c(e, t, n, r) {
    if (oe.acceptData(e)) {
      ...
      if (
        ...
        return (
          u || (u = s ? (e[a] = U.pop() || oe.guid++) : a),
          l[u] || (l[u] = s ? {} : { toJSON: oe.noop }),
          ("object" == typeof t || "function" == typeof t) &&
            (r
              ? (l[u] = oe.extend(l[u], t))
              : (l[u].data = oe.extend(l[u].data, t))),
          (o = l[u]),
          r || (o.data || (o.data = {}), (o = o.data)),
          void 0 !== n && (o[oe.camelCase(t)] = n),
          "string" == typeof t
            ? null == (i = o[t]) && (i = o[oe.camelCase(t)])
            : (i = o),
          i
        );
    }
      ...
      if (a[s]) {
        if (t && (r = n ? a[s] : a[s].data)) {
          oe.isArray(t)
            ...
            : t in r
            ? (t = [t])
            : ((t = oe.camelCase(t)), (t = t in r ? [t] : t.split(" "))),
            (i = t.length);
          for (; i--; ) delete r[t[i]];
  ...
  function E(e) {
    ...
    return (
      n ||
        ...
        ("none" !== n && n) ||
          ((Je = (
            Je || oe("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function S(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = st.length;
      i--;
        ...
        r.style &&
          ...
          t
            ? (o[a] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
                Ee(r) &&
                (o[a] = oe._data(r, "olddisplay", E(r.nodeName))))
            : o[a] ||
              ((i = Ee(r)),
              ((n && "none" !== n) || !i) &&
                oe._data(r, "olddisplay", i ? n : oe.css(r, "display"))));
    for (a = 0; s > a; a++)
      (r = e[a]),
        r.style &&
  ...
  function L(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += oe.css(e, n + Ne[o], !0, i)),
        r
          ? ("content" === n && (a -= oe.css(e, "padding" + Ne[o], !0, i)),
            "margin" !== n &&
              (a -= oe.css(e, "border" + Ne[o] + "Width", !0, i)))
          : ((a += oe.css(e, "padding" + Ne[o], !0, i)),
            "padding" !== n &&
              (a += oe.css(e, "border" + Ne[o] + "Width", !0, i)));
    return a;
  }
              ...
              (e = a[r]),
                ...
                a !== n &&
                  (u && n && (oe.isPlainObject(n) || (t = oe.isArray(n)))
                    ? (t
                        ? ((t = !1), (o = e && oe.isArray(e) ? e : []))
                        : (o = e && oe.isPlainObject(e) ? e : {}),
                      (a[r] = oe.extend(u, o, n)))
                    : void 0 !== n && (a[r] = n));
        return a;
      }),
  ...
  var se = (function (e) {
      ...
      return (
        ...
        r(function (r, a, s, l) {
          var u,
            ...
            b = n ? (o || (r ? e : m || i) ? [] : a) : v;
          if ((n && n(v, b, s, l), i))
            for (u = h(b, p), i(u, [], s, l), c = u.length; c--; )
              (d = u[c]) && (b[p[c]] = !(v[p[c]] = d));
          if (r) {
            if (o || e) {
              if (o) {
              ...
              for (c = b.length; c--; )
                (d = b[c]) &&
                  (u = o ? Z.call(r, d) : f[c]) > -1 &&
                  (r[u] = !(a[u] = d));
            }
          } else (b = h(b === a ? b.splice(m, b.length) : b)), o ? o(null, a, b, l) : Y.apply(a, b);
        })
      );
    }
    function g(e) {
      ...
      var i = n.length > 0,
        ...
        a = function (r, a, s, l, u) {
          var c,
            ...
            w = b.length;
          for (u && (k = a !== L && a); m !== w && null != (c = b[m]); m++) {
            if (o && c) {
              for (d = 0; (f = e[d++]); )
                if (f(c, a, s)) {
                  l.push(c);
    ...
    try {
      Y.apply((U = K.call(B.childNodes)), B.childNodes),
    ...
    (w = t.support = {}),
          ...
          return n !== L && 9 === n.nodeType && n.documentElement
            ? ((L = n),
              ...
              (T.find.TAG = w.getElementsByTagName
                ? function (e, t) {
                    return typeof t.getElementsByTagName !== X
              ...
              (T.find.CLASS =
                w.getElementsByClassName &&
                function (e, t) {
                  return typeof t.getElementsByClassName !== X && H
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      (!w.sortDetached && t.compareDocumentPosition(e) === r)
                        ? e === n || (e.ownerDocument === B && F(B, e))
                          ? -1
                          : t === n || (t.ownerDocument === B && F(B, t))
                          ? 1
                          : S
                          ? Z.call(S, e) - Z.call(S, t)
                          : 0
                        : 4 & r
                        ? -1
                        : 1)
      ...
      (t.matchesSelector = function (e, n) {
        if (
          ...
          (n = n.replace(ue, "='$1']")),
          !(!w.matchesSelector || !H || (_ && _.test(n)) || (M && M.test(n))))
        )
          try {
            var r = q.call(e, n);
            if (
    ...
    return (
      ...
      (w.sortStable = O.split("").sort(I).join("") === O),
  ...
  (oe.find = se),
    (oe.expr = se.selectors),
    (oe.expr[":"] = oe.expr.pseudos),
    (oe.unique = se.uniqueSort),
    (oe.text = se.getText),
    (oe.isXMLDoc = se.isXML),
    (oe.contains = se.contains);
    ...
    if ("string" == typeof e) {
      ...
      if (n[1]) {
        if (
          ...
          oe.merge(
            this,
            oe.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : fe, !0)
          ),
          ue.test(n[1]) && oe.isPlainObject(t))
        )
          for (n in t)
  ...
  oe.extend({
    dir: function (e, t, n) {
      for (
        ...
        i &&
        9 !== i.nodeType &&
        (void 0 === n || 1 !== i.nodeType || !oe(i).is(n));
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            o = [],
            a =
              le.test(e) || "string" != typeof e ? oe(e, t || this.context) : 0;
          i > r;
          r++
        )
      ...
      function (e, t) {
        oe.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (me[e] || (i = oe.unique(i)), he.test(e) && (i = i.reverse())),
            this.pushStack(i)
          );
        };
      }
    ...
    oe.extend({
      ...
      ready: function (e) {
        if (!0 === e ? !--oe.readyWait : !oe.isReady) {
          ...
          (oe.isReady = !0),
            (!0 !== e && --oe.readyWait > 0) ||
              (ye.resolveWith(fe, [oe]),
              oe.fn.trigger && oe(fe).trigger("ready").off("ready"));
        }
      },
    }),
    (oe.ready.promise = function (t) {
      if (!ye)
        if (((ye = oe.Deferred()), "complete" === fe.readyState))
          setTimeout(oe.ready);
    ...
    oe(function () {
      ...
      n &&
        ...
        typeof t.style.zoom !== xe &&
          ...
          (re.inlineBlockNeedsLayout = 3 === t.offsetWidth) &&
            (n.style.zoom = 1)),
        n.removeChild(e),
        (e = t = null));
    }),
  ...
  oe.extend({
    ...
    hasData: function (e) {
      return (
        !!(e = e.nodeType ? oe.cache[e[oe.expando]] : e[oe.expando]) && !u(e)
      );
    },
    data: function (e, t, n) {
      return c(e, t, n);
    ...
    oe.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = oe.data(o)), 1 === o.nodeType && !oe._data(o, "parsedAttrs"))
          ) {
            for (n = a.length; n--; )
              (r = a[n].name),
                0 === r.indexOf("data-") &&
                  ((r = oe.camelCase(r.slice(5))), l(o, r, i[r]));
  ...
  var Ce = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    ke = (oe.access = function (e, t, n, r, i, o, a) {
      var s = 0,
        l = e.length,
        u = null == n;
      if ("object" === oe.type(n)) {
    ...
    (function () {
      ...
      for (t in { submit: !0, change: !0, focusin: !0 })
        (n = "on" + t),
          (re[t + "Bubbles"] = n in e) ||
            (r.setAttribute(n, "t"),
            (re[t + "Bubbles"] = !1 === r.attributes[n].expando));
      r = null;
    })();
  ...
  (oe.event = {
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !u.noBubble && !oe.isWindow(r)) {
          for (
            l = u.delegateType || p, De.test(l + p) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            f.push(s), (c = s);
          c === (r.ownerDocument || fe) &&
            f.push(c.defaultView || c.parentWindow || e);
        }
        for (d = 0; (s = f[d++]) && !t.isPropagationStopped(); )
          (t.type = d > 1 ? l : u.bindType || p),
            (o =
              (oe._data(s, "events") || {})[t.type] && oe._data(s, "handle")),
            o && o.apply(s, n),
            (o = a && s[a]) &&
              o.apply &&
              oe.acceptData(s) &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = oe.event.handlers.call(this, e, l), t = 0;
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            Le.test(i) ? this.mouseHooks : Ae.test(i) ? this.keyHooks : {}),
    ...
    (oe.removeEvent = fe.removeEventListener
      ...
      : function (e, t, n) {
          var r = "on" + t;
          e.detachEvent &&
            (typeof e[r] === xe && (e[r] = null), e.detachEvent(r, n));
        }),
    ...
    re.submitBubbles ||
      (oe.event.special.submit = {
        ...
        teardown: function () {
          return (
            !oe.nodeName(this, "form") && void oe.event.remove(this, "._submit")
          );
        },
      }),
    re.changeBubbles ||
  ...
  (Ie.optgroup = Ie.option),
    ...
    oe.extend({
      clone: function (e, t, n) {
        ...
        if (
          (re.html5Clone || oe.isXMLDoc(e) || !_e.test("<" + e.nodeName + ">")
            ? (o = e.cloneNode(!0))
            ...
            if ("object" === oe.type(o)) oe.merge(p, o.nodeType ? [o] : o);
              ...
              for (
                s = s || f.appendChild(t.createElement("div")),
                  l = (Oe.exec(o) || ["", ""])[1].toLowerCase(),
                  c = Ie[l] || Ie._default,
                  s.innerHTML = c[1] + o.replace(Fe, "<$1></$2>") + c[2],
                  i = c[0];
                i--;
              ...
              if (
                (!re.leadingWhitespace &&
                  qe.test(o) &&
                  p.push(t.createTextNode(qe.exec(o)[0])),
                !re.tbody)
              )
                for (
                  o =
                  ...
                  oe.nodeName((u = o.childNodes[i]), "tbody") &&
                    !u.childNodes.length &&
                    o.removeChild(u);
              for (
    ...
    oe.fn.extend({
        ...
        return ke(
          ...
          function (e) {
            return void 0 === e
              ? oe.text(this)
              : this.empty().append(
                  ((this[0] && this[0].ownerDocument) || fe).createTextNode(e)
                );
          },
          null,
          e,
      ...
      html: function (e) {
        return ke(
          ...
          function (e) {
            ...
            if (void 0 === e)
              return 1 === t.nodeType
                ? t.innerHTML.replace(/ jQuery\d+="(?:null|\d+)"/g, "")
                : void 0;
            if (
              !(
                "string" != typeof e ||
                Re.test(e) ||
                (!re.htmlSerialize && _e.test(e)) ||
                (!re.leadingWhitespace && qe.test(e)) ||
                Ie[(Oe.exec(e) || ["", ""])[1].toLowerCase()]
              )
            ) {
              e = e.replace(Fe, "<$1></$2>");
              try {
      ...
      domManip: function (e, t) {
        ...
        if (
          p ||
          (u > 1 && "string" == typeof f && !re.checkClone && $e.test(f))
        )
        ...
        if (
          ...
          for (o = oe.map(g(s, "script"), b), i = o.length; u > l; l++)
            (r = s),
              l !== d &&
                ((r = oe.clone(r, !0, !0)), i && oe.merge(o, g(r, "script"))),
              t.call(this[l], r, l);
          if (i)
            for (
              a = o[o.length - 1].ownerDocument, oe.map(o, x), l = 0;
              i > l;
              l++
            )
              (r = o[l]),
    ...
    !(function () {
      function t() {
        ...
        r &&
          ...
          oe.swap(r, null != r.style.zoom ? { zoom: 1 } : {}, function () {
            i = 4 === n.offsetWidth;
          }),
          (o = !0),
          (a = !1),
          ...
          reliableMarginRight: function () {
            ...
            if (null == s && e.getComputedStyle) {
              ...
              (n = fe.createElement("div")),
                ...
                (i = r.appendChild(fe.createElement("div"))),
  ...
  oe.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          ((t = oe.cssProps[s] || (oe.cssProps[s] = S(l, s))),
        ...
        if (
          ...
          "string" === o &&
            (i = it.exec(n)) &&
            ((n = (i[1] + 1) * i[2] + parseFloat(oe.css(e, t))),
            (o = "number")),
          null != n &&
            n === n &&
            ("number" !== o || oe.cssNumber[s] || (n += "px"),
            re.clearCloneStyle ||
              "" !== n ||
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s = oe.camelCase(t);
      return (
        (t = oe.cssProps[s] || (oe.cssProps[s] = S(e.style, s))),
        (a = oe.cssHooks[t] || oe.cssHooks[s]),
        a && "get" in a && (o = a.get(e, !0, n)),
        void 0 === o && (o = Ge(e, t, r)),
        "normal" === o && t in at && (o = at[t]),
        "" === n || n
          ? ((i = parseFloat(o)), !0 === n || oe.isNumeric(i) ? i || 0 : o)
          : o
      );
    },
  }),
    oe.each(["height", "width"], function (e, t) {
      oe.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? 0 === e.offsetWidth && nt.test(oe.css(e, "display"))
              ? oe.swap(e, ot, function () {
                  return D(e, t, r);
                })
              : D(e, t, r)
            : void 0;
    ...
    re.opacity ||
      (oe.cssHooks.opacity = {
        ...
        set: function (e, t) {
          ...
          (n.zoom = 1),
            ((t >= 1 || "" === t) &&
              "" === oe.trim(o.replace(et, "")) &&
              n.removeAttribute &&
              (n.removeAttribute("filter"), "" === t || (r && !r.filter))) ||
              (n.filter = et.test(o) ? o.replace(et, i) : o + " " + i);
        },
      }),
    (oe.cssHooks.marginRight = k(re.reliableMarginRight, function (e, t) {
      return t
        ? oe.swap(e, { display: "inline-block" }, Ge, [e, "marginRight"])
        : void 0;
    })),
      ...
      "*": [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            a =
              (oe.cssNumber[e] || ("px" !== o && +r)) &&
              dt.exec(oe.css(n.elem, e)),
            s = 1,
            l = 20;
          if (a && a[3] !== o) {
            (o = o || a[3]), (i = i || []), (a = +r || 1);
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === xe
            ...
            : ((1 === o && oe.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r =
                  oe.attrHooks[t] || (oe.expr.match.bool.test(t) ? gt : mt))),
              void 0 === n
      ...
      set: function (e, t, n) {
        return (
          !1 === t
            ? oe.removeAttr(e, n)
            : (xt && bt) || !yt.test(n)
            ? e.setAttribute((!bt && oe.propFix[n]) || n, n)
        ...
        : this.each(
            oe.isFunction(e)
              ...
              : function () {
                  if ("string" === n)
                    for (
                      var t, r = 0, i = oe(this), o = e.match(ge) || [];
                      (t = o[r++]);
    ...
    oe.extend({
      ...
      ajax: function (e, t) {
          ...
          2 !== b &&
            ...
            i
              ? (d.ifModified &&
                  ...
                  (x = w.getResponseHeader("etag")) && (oe.etag[o] = x)),
                204 === e || "HEAD" === d.type
                  ? (T = "nocontent")
                  : 304 === e
                  ? (T = "notmodified")
        ...
        (l = d.global),
          ...
          d.hasContent ||
            (d.data &&
              ((o = d.url += (Et.test(o) ? "&" : "?") + d.data), delete d.data),
            !1 === d.cache &&
              (d.url = jt.test(o)
                ? o.replace(jt, "$1_=" + Nt++)
                : o + (Et.test(o) ? "&" : "?") + "_=" + Nt++)),
  ...
  e.ActiveXObject &&
    ...
    (re.cors = !!$t && "withCredentials" in $t),
    ($t = re.ajax = !!$t) &&
  ...
  (oe.offset = {
    ...
    oe.each(["top", "left"], function (e, t) {
      oe.cssHooks[t] = k(re.pixelPosition, function (e, n) {
        return n
          ? ((n = Ge(e, t)), Ke.test(n) ? oe(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
  ...
  return (
    (oe.noConflict = function (t) {
      return (
        e.$ === oe && (e.$ = Jt), t && e.jQuery === oe && (e.jQuery = Qt), oe
      );
    }),
    typeof t === xe && (e.jQuery = e.$ = oe),
    oe
  );
}),
  ...
  (function (e, t, n) {
    ...
    i(e, "attrFn", a || {}, "jQuery.attrFn is deprecated"),
      (e.attr = function (t, i, o, l) {
        var u = i.toLowerCase(),
          h = t && t.nodeType;
        return l &&
          (4 > s.length && r("jQuery.fn.attr( props, pass ) is deprecated"),
          t && !d.test(h) && (a ? i in a : e.isFunction(e.fn[i])))
          ? e(t)[i](o)
          : ("type" === i &&
              o !== n &&
              c.test(t.nodeName) &&
    ...
    (e.fn.init = function (t, n, i) {
      ...
      return t &&
        ...
        e.parseHTML)
        ? g.call(this, e.parseHTML(o[2], n, !0), n, i)
      ...
      e.browser ||
        ((h = e.uaMatch(navigator.userAgent)),
        (m = {}),
      ...
      (e.sub = function () {
        ...
        e.extend(!0, t, this),
          ...
          (t.fn.init = function (r, i) {
            return (
              i && i instanceof e && !(i instanceof t) && (i = t(i)),
        ...
        (e.clean = function (t, i, o, a) {
          ...
          if ((e.merge(d, e.buildFragment(t, i).childNodes), o))
            for (
              ...
              (e.nodeName(l, "script") && u(l)) ||
                (o.appendChild(l),
                l.getElementsByTagName !== n &&
                  ((c = e.grep(
    ...
    e.event.props &&
      ...
      (e.fn.live = function (t, n, i) {
        return (
          ...
          k
            ...
            : (e(this.context).on(t, this.selector, n, i), this)
        );
      }),
      ...
      (e.event.trigger = function (e, t, n, i) {
        return (
          n || A.test(e) || r("Global events are undocumented and deprecated"),
      ...
      n.push(function () {
        ...
        clearTimeout(t),
          (t = setTimeout(function () {
            i.apply(e, [].slice.call(n));
          }, r));
      }),
      methods[e].apply(this, isNaN(r) || void 0 === i ? arguments : n)
    );
  };
});
