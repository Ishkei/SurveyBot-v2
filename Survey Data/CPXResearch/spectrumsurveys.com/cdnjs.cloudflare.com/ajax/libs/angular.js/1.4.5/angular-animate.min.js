...
(function (F, x, Z) {
  ...
  function R(a, b, c) {
    ...
    c.preparationClasses &&
      ((b.preparationClasses = W(c.preparationClasses, b.preparationClasses)),
  ...
  var L = x.noop,
    ...
    X,
    sa;
  F.ontransitionend === Z && F.onwebkittransitionend !== Z
    ? ((N = "WebkitTransition"), (ra = "webkitTransitionEnd transitionend"))
    : ((N = "transition"), (ra = "transitionend"));
  F.onanimationend === Z && F.onwebkitanimationend !== Z
    ? ((X = "WebkitAnimation"), (sa = "webkitAnimationEnd animationend"))
    : ((X = "animation"), (sa = "animationend"));
  var ka = X + "Delay",
    ta = X + "Duration",
    ga = N + "Delay";
  F = N + "Duration";
    ...
    .provider("$$animateQueue", [
      ...
      function (a) {
        ...
        this.$get = [
          ...
          "$$jqLite",
          "$$forceReflow",
          function (d, y, v, z, l, s, O, x, t, la, E) {
            function h(a, b) {
              var c = G(a),
                f = [],
                g = w[b];
            ...
            function u(a, g, m) {
              ...
              if (v) {
                ...
                else if (b("join", a, h, k))
                  if (2 === k.state) R(a, m, {});
                  else
                    return (
                      Ja(a, l ? g : null, m),
                      (g = h.event = k.event),
                      (m = R(a, k.options, h.options)),
                      k.runner
                    );
              } else R(a, m, {});
              (v = h.structural) ||
            ...
            function p(a, b, c) {
              ...
              for ((a = a.data("$ngAnimatePin")) && (b = a); b && b.length; ) {
                ...
                if (La(d) || !0 === d)
                  (a = b.data("$$ngAnimateChildren")), Ma(a) && (d = a);
                if (f && !1 === d) break;
                g ||
                  ((g = B(b, v)),
                  g || ((a = b.data("$ngAnimatePin")) && (b = a)));
                c || (c = B(b, l));
                b = b.parent();
              }
              return (!f || d) && g && c;
          ...
          function (a, e, y, v, z, l) {
            function s(a) {
              ...
              for (d = 0; d < a.length; d++) {
                ...
                e.put(
                  l.domNode,
                  (a[d] = { domNode: l.domNode, fn: l.fn, children: [] })
                );
              }
            ...
            return function (t, z, E) {
              ...
              var U = va(t.attr("class"), va(E.addClass, E.removeClass)),
                H = E.tempClasses;
    ...
    .provider("$animateCss", [
      ...
      function (a) {
        ...
        this.$get = [
          ...
          "$$rAFScheduler",
          "$animate",
          function (a, e, y, v, z, l, s, O) {
            function x(a, b) {
              var c = a.parentNode;
              return (
                (c.$$ngAnimateParentKey || (c.$$ngAnimateParentKey = ++S)) +
                "-" +
            ...
            function t(h, f, l, p) {
              ...
              0 < b.count(l) &&
                ...
                r ||
                  ...
                  e.addClass(h, f),
                  (r = za(a, h, p)),
                  (r.animationDuration = Math.max(r.animationDuration, 0)),
                  (r.transitionDuration = Math.max(r.transitionDuration, 0)),
                  e.removeClass(h, f),
                  c.put(l, r)));
              return r || {};
            }
            ...
            return function (a, c) {
              ...
              function H() {
                function b() {
                  if (!s) {
                    ...
                    n.applyAnimationDelay &&
                      ((Y =
                        "boolean" !== typeof c.delay && oa(c.delay)
                          ? parseFloat(c.delay)
                          : Y),
                      (I = Math.max(Y, 0)),
                      (D.animationDelay = Y),
                    ...
                    if (p.length) {
                      var C = p[0];
                      (z = k > C.expectedEndTime)
                        ? v.cancel(C.timer)
                        : p.push(r);
                    }
                    z &&
                      ((u = v(d, u, !1)),
                      (p[0] = { timer: u, expectedEndTime: k }),
                      p.push(r),
                      a.data("$$animateCss", p));
                    a.on(m.join(" "), l);
                    xa(a, c);
                ...
                if (!s)
                  if (g.parentNode) {
                    var H,
                      ...
                      k = function (a) {
                        if (S) z && a && ((z = !1), r());
                        else if (((z = !a), D.animationDuration))
                          if (((a = na(g, z)), z)) w.push(a);
                          else {
                            var b = w,
                              c = b.indexOf(a);
                            0 <= a && b.splice(c, 1);
                      ...
                      p =
                        0 < W &&
                        ((D.transitionDuration && 0 === T.transitionDuration) ||
                          (D.animationDuration && 0 === T.animationDuration)) &&
              ...
              if (0 === c.duration || (!l.animations && !l.transitions))
                return u();
              var ca = c.event && $(c.event) ? c.event.join(" ") : c.event,
                R = "",
                P = "";
              ca && c.structural ? (R = V(ca, "ng-", !0)) : ca && (R = ca);
              c.addClass && (P += V(c.addClass, "-add"));
              c.removeClass &&
                (P.length && (P += " "), (P += V(c.removeClass, "-remove")));
              ...
              c.transitionStyle &&
                ((C = [N, c.transitionStyle]), fa(g, C), w.push(C));
              0 <= c.duration &&
                ((C = 0 < g.style[N].length),
                (C = Aa(c.duration, C)),
                fa(g, C),
                w.push(C));
              c.keyframeStyle &&
                ((C = [X, c.keyframeStyle]), fa(g, C), w.push(C));
              var W = T
                ? 0 <= c.staggerIndex
                  ? c.staggerIndex
                  : b.count(ba)
              ...
              n.hasAnimations = 0 < D.animationDuration;
              n.hasTransitionAll =
                n.hasTransitions && "all" == D.transitionProperty;
              n.applyTransitionDuration =
                k &&
                ((n.hasTransitions && !n.hasTransitionAll) ||
                  (n.hasAnimations && !n.hasTransitions));
              n.applyAnimationDuration = c.duration && n.hasAnimations;
              n.applyTransitionDelay =
                oa(c.delay) && (n.applyTransitionDuration || n.hasTransitions);
              ...
              if (n.applyTransitionDuration || n.applyAnimationDuration)
                (K = c.duration ? parseFloat(c.duration) : K),
                  n.applyTransitionDuration &&
                    ((n.hasTransitions = !0),
                    (D.transitionDuration = K),
                    (C = 0 < g.style[N + "Property"].length),
                    w.push(Aa(K, C))),
                  n.applyAnimationDuration &&
                    ((n.hasAnimations = !0),
              ...
              null == c.duration &&
                ...
                (n.recalculateTimingStyles = n.recalculateTimingStyles || ca);
              M = 1e3 * I;
              Q = 1e3 * K;
              c.skipBlocking ||
                ((n.blockTransition = 0 < D.transitionDuration),
                (n.blockKeyframeAnimation =
                  0 < D.animationDuration &&
                  0 < T.animationDelay &&
                  0 === T.animationDuration));
              wa(a, c);
              n.blockTransition || n.blockKeyframeAnimation
                ? A(K)
                : c.skipBlocking || ja(g, !1);
              return {
                $$willAnimate: !0,
                end: d,
                start: function () {
                  if (!s)
                    return (
                      (F = { end: d, cancel: p, resume: null, pause: null }),
                      (m = new y(F)),
                      la(H),
                      m
                    );
      ...
      function (a) {
        ...
        this.$get = [
          ...
          function (a, c, d, e, y, v, z) {
            ...
            return function (a) {
              return a.from && a.to
                ? x(a.from, a.to, a.classes, a.anchors)
                : t(a);
            };
          },
        ];
          ...
          function (b, c, d) {
            ...
            return function (a, b, d, s) {
                ...
                if (0 === g.length) {
                  ...
                  "beforeSetClass" === f
                    ? ((h = t(a, "removeClass", d, e, "beforeRemoveClass")),
                      (k = t(a, "addClass", d, e, "beforeAddClass")))
                    : "setClass" === f &&
                      ((h = t(a, "removeClass", d, e, "removeClass")),
                      (k = t(a, "addClass", d, e, "addClass")));
                  h && (g = g.concat(h));
                  k && (g = g.concat(k));
                }
                if (0 !== g.length)
              ...
              if (I.length) {
                var f, B;
                "leave" == b
                  ? ((B = "leave"), (f = "afterLeave"))
                  : ((B = "before" + b.charAt(0).toUpperCase() + b.substr(1)),
                    (f = b));
