...
(function (module, require, window, angular) {
  ...
  var OS_VERSIONS_RE = Object.keys(OS_VERSIONS_RE_MAP).reduce(function (
    obj,
    key
  ) {
  ...
  var BROWSER_VERSIONS_RE = Object.keys(BROWSER_VERSIONS_RE_MAP).reduce(
    function (obj, key) {
  ...
  function parseUserAgent(options) {
    ...
    deviceInfo.raw.os_version = Object.keys(OS_VERSIONS).reduce(function (
      obj,
      item
    ) {
    ...
    deviceInfo.os = [
      ...
      return previousValue === OS.UNKNOWN && deviceInfo.raw.os[currentValue]
        ? currentValue
        : previousValue;
    }, OS.UNKNOWN);
    ...
    deviceInfo.browser = [
      ...
      return previousValue === BROWSERS.UNKNOWN &&
        deviceInfo.raw.browser[currentValue]
        ? currentValue
        : previousValue;
    }, BROWSERS.UNKNOWN);
    ...
    deviceInfo.device = [
      ...
      return previousValue === DEVICES.UNKNOWN &&
        deviceInfo.raw.device[currentValue]
        ? currentValue
        : previousValue;
    }, DEVICES.UNKNOWN);
    ...
    deviceInfo.custom = customDetectors.reduce(function (
      custom,
      customDetector
    ) {
  ...
  if (!!angular) {
    angular
      .module("uaDeviceDetector", ["reTree"])
