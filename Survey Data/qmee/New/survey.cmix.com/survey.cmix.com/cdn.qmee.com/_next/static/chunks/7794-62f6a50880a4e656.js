            ...
            (function (n) {
              ...
              return (
                ...
                (e.prototype.convertAnimationProp = function (t, n) {
                  switch ("undefined" === typeof t ? "undefined" : m(t)) {
                    case "boolean":
                      return n[t ? h : "none"];
                    case "string":
                      return -1 === Object.keys(n).indexOf(t)
                        ? n.elevator
                        : n[t];
                    default:
                      return t;
      ...
      var x = (function (t) {
          function n() {
            ...
            return (
              ...
              (i.state = {
                children: O(i.props ? i.props.children : []).map(function (t) {
          ...
          return (
            ...
            (n.prototype.componentDidUpdate = function (t) {
              null === this.props.typeName && this.findDOMContainer(),
                !(function (t, n) {
                  ...
                  O(this.props.children).map(function (t) {
                    return t.key;
                  }),
              ...
              var n = this,
                e = t.map(function (t) {
                  var e = n.findChildByKey(t.key),
                    i = !e || e.leaving;
                  return y({}, t, { element: t, entering: i });
                }),
                i = 0;
              return (
            ...
            (n.prototype.prepForAnimation = function () {
              ...
              this.state.children.forEach(function (n) {
                var e = t.getChildData(E(n)).domNode;
                e &&
                  (n.entering ||
                    n.leaving ||
                    D({ domNode: e, styles: { transition: "" } }));
              });
            }),
            ...
            (n.prototype.animateChild = function (t, n, e) {
              var i = this,
                o = this.getChildData(E(t)).domNode;
              o &&
                (D({ domNode: o, styles: e }),
                this.props.onStart && this.props.onStart(t, o),
                requestAnimationFrame(function () {
                  requestAnimationFrame(function () {
                    var e = {
                      transition: C(n, i.props),
                      transform: "",
                      opacity: "",
                    };
            ...
            (n.prototype.bindTransitionEndHandler = function (t) {
              var n = this,
                e = this.getChildData(E(t)).domNode;
              if (e) {
                e.addEventListener(P, function i(o) {
                  o.target === e &&
                    ((e.style.transition = ""),
                    n.triggerFinishHooks(t, e),
                    e.removeEventListener(P, i),
                    t.leaving && n.removeChildData(E(t)));
                });
              }
            }),
...
//# sourceMappingURL=7794-62f6a50880a4e656.js.map
