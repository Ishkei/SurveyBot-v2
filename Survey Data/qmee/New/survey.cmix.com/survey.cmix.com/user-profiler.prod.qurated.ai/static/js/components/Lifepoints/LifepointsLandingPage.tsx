...
import { ReactComponent as LifepointsLandingPageGraphic } from "../../assets/panels/lifepoints-landing-page-graphic.svg";
import { Link, useLocation, useNavigate } from "react-router-dom";
import { GetOnboardingWording } from "../../providers/PanelBrandSettingsProvider";
import Txt from "../common/Txt";
import WhyDoWeAskPopup from "./WhyDoWeAskPopup";
import profilerFinishedRedirect from "../../utils/ProfilerFinishedRedirect";
import LifepointsLandingExitModal from "./LifepointsLandingExitModal";

const LifepointsLandingPage = () => {
...
export default LifepointsLandingPage;
