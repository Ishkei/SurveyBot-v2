        ...
        this.each(function () {
          ...
          function e() {
            ...
            var c = g.offset().left,
              e = 0,
              f = h.gutter;
            c + i.innerWidth() > a(window).width() &&
              ((e = g.innerWidth() - i.innerWidth()), (f = -1 * f)),
              i.css({
                position: "absolute",
      ...
      return this.each(function () {
        function b() {
          ...
          g.velocity("stop", !0),
            ...
            g.velocity(
              { width: e, height: h, left: 0, top: 0 },
              { duration: f, queue: !1, easing: "easeOutQuad" }
            ),
          ...
          g.wrap(h),
            g.on("click", function () {
              ...
              if (
                ...
                l.velocity(
                  { opacity: 1 },
                  { duration: e, queue: !1, easing: "easeOutQuad" }
                ),
                "" !== g.data("caption"))
              ) {
              ...
              var n = 0,
                ...
                r = 0;
              o > p
                ? ((n = k / j), (q = 0.9 * h), (r = 0.9 * h * n))
                : ((n = j / k), (q = 0.9 * i * n), (r = 0.9 * i)),
                          ...
                          g.css({ left: 0, top: 0 }).velocity(
                            {
                              ...
                              left:
                                ...
                                h / 2 -
                                g.parent(".material-placeholder").offset()
                                  .left -
                                q / 2,
                              top:
                                a(document).scrollTop() +
                                i / 2 -
                                g.parent(".material-placeholder").offset().top -
                                r / 2,
                            },
                            {
                              duration: e,
                      ...
                      .velocity(
                        {
                          ...
                          left:
                            a(document).scrollLeft() +
                            h / 2 -
                            g.parent(".material-placeholder").offset().left -
                            q / 2,
                          top:
                            a(document).scrollTop() +
                            i / 2 -
              ...
              mouseenter: function () {
                ...
                (a = void 0 === a || "" === a ? b.delay : a),
                  ...
                  (e = setInterval(function () {
                    if (((c += 10), c >= a && d === !1)) {
                      (d = !0),
                        i.css({ display: "block", left: "0px", top: "0px" }),
                      ...
                      "top" === h
                        ...
                        : (i.css({
                          ...
                          (m = "+10px"),
                          j.css({ marginLeft: l / 2 - j.width() / 2 })),
                        (o = l / 8),
                        8 > o && (o = 8),
                        ("right" === h || "left" === h) &&
                          ((o = l / 10), 6 > o && (o = 6)),
                        i.velocity(
                          { opacity: 1, marginTop: m, marginLeft: n },
                  ...
                  if ("touch" == d.gesture.pointerType) {
                    ...
                    if (
                      ...
                      f < window.innerWidth - b.menuWidth / 2
                        ? (g = !0)
                        : f >= window.innerWidth - b.menuWidth / 2 && (g = !1);
      ...
      (a.fn.material_select = function (b) {
        a(this).each(function () {
          if ((($select = a(this)), !$select.hasClass("browser-default"))) {
            ...
            (f =
              void 0 !== $select.find("option:selected")
              ...
              g.find("li").each(function (c) {
                ...
                a(this).click(function () {
                  a(this).hasClass("disabled") ||
                    (d.find("option").eq(c).prop("selected", !0),
                    d.trigger("change"),
            ...
            $select.before(j),
              ...
              $select.attr("tabindex") &&
                a(j[0]).attr("tabindex", $select.attr("tabindex")),
              ...
              (onKeyDown = function (b) {
                ...
                if (13 != b.which || g.is(":visible")) {
                  ...
                  letter &&
                    ...
                    13 == b.which &&
                      ((activeOption = g.find("li.active:not(.disabled)")[0]),
                      activeOption &&
                        (a(activeOption).trigger("click"), j.trigger("close"))),
                    40 == b.which &&
                      ((newOption = g
                        .find("li.active")
      ...
      init: function (b) {
        ...
        return (
          ...
          this.each(function () {
            ...
            if (
              (-1 != i && (e = h.eq(i)),
              f.hasClass("fullscreen") ||
                (f.height(b.indicators ? b.height + 40 : b.height),
                g.height(b.height)),
