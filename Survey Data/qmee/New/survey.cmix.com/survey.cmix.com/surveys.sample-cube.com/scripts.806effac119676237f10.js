!(function (e, t) {
  ...
  (b.filter = function (e, t, n) {
    ...
    b.fn.extend({
      ...
      is: function (e) {
        return !!j(this, "string" == typeof e && S.test(e) ? b(e) : e || [], !1)
          .length;
      },
    });
  var N,
        ...
        if ("object" === x(o)) b.merge(p, o.nodeType ? [o] : o);
          ...
          for (
            a = a || f.appendChild(t.createElement("div")),
              ...
              a.innerHTML =
                (u = pe[s] || pe._default)[1] + b.htmlPrefilter(o) + u[2],
              c = u[0];
            c--;
        ...
        for (
          ...
          (d = g = (s = be.exec(t[l]) || [])[1]),
            ...
            d &&
              ((f = b.event.special[d] || {}),
              (f =
                b.event.special[(d = (i ? f.delegateType : f.bindType) || d)] ||
                {}),
              (c = b.extend(
                {
                  type: d,
  ...
  b.extend(b.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        if (!o && !d.noBubble && !v(i)) {
          for (
            gt.test((l = d.delegateType || m) + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            y.push(s), (u = s);
...
//# sourceMappingURL=scripts.806effac119676237f10.js.map
