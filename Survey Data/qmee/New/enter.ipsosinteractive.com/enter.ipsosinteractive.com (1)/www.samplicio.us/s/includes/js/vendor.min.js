...
function getContrastColor(color) {
  return parseInt(toHex(color).replace("#", ""), 16) > 8388607.5
    ? "black"
    : "white";
}
function adjustLuminosity(color, amount) {
  color = toHex(color);
  amount = Math.round(2.55 * amount);
...
(function ($, undefined) {
  ...
  $.Widget.prototype = {
    ...
    _delay: function (handler, delay) {
      function handlerProxy() {
        return ("string" == typeof handler ? instance[handler] : handler).apply(
          instance,
          arguments
        );
      }
    ...
    _mouseInit: function () {
      ...
      this.element
        ...
        .bind("click." + this.widgetName, function (event) {
          if (
            !0 === $.data(event.target, that.widgetName + ".preventClickEvent")
          ) {
    ...
    _mouseDown: function (event) {
      if (!mouseHandled) {
        ...
        var that = this,
          ...
          elIsCancel =
            !(
              "string" != typeof this.options.cancel || !event.target.nodeName
        ...
        !0 === $.data(event.target, this.widgetName + ".preventClickEvent") &&
...
(function ($, undefined) {
  ...
  $.fn.position = function (options) {
    ...
    "right" === options.at[0]
      ...
      : "center" === options.at[0] && (basePosition.left += targetWidth / 2);
    "bottom" === options.at[1]
      ? (basePosition.top += targetHeight)
      : "center" === options.at[1] && (basePosition.top += targetHeight / 2);
    ...
    return this.each(function () {
      ...
      "right" === options.my[0]
        ...
        : "center" === options.my[0] && (position.left -= elemWidth / 2);
      "bottom" === options.my[1]
        ? (position.top -= elemHeight)
        : "center" === options.my[1] && (position.top -= elemHeight / 2);
      ...
      left: function (position, data) {
        ...
        if (overLeft < 0) {
          newOverRight =
            ...
            outerWidth -
            withinOffset;
          (newOverRight < 0 || newOverRight < abs(overLeft)) &&
          ...
          newOverLeft =
            ...
            offset -
            offsetLeft;
          (newOverLeft > 0 || abs(newOverLeft) < overRight) &&
            (position.left += myOffset + atOffset + offset);
        }
      },
      top: function (position, data) {
  ...
  $.widget("ui.accordion", {
    ...
    _create: function () {
      ...
      this.element
        ...
        .attr("role", "tablist");
      options.collapsible ||
        (!1 !== options.active && null != options.active) ||
        (options.active = 0);
      this._processPanels();
    ...
    refresh: function () {
      ...
      this._processPanels();
      if (
        (!1 === options.active && !0 === options.collapsible) ||
        !this.headers.length
      ) {
        options.active = !1;
        this.active = $();
    ...
    _eventHandler: function (event) {
      ...
      if (
        ...
        !1 !== this._trigger("beforeActivate", event, eventData)
      ) {
        options.active = !collapsing && this.headers.index(clicked);
    ...
    _animate: function (toShow, toHide, data) {
      ...
      toShow.hide().animate(showProps, {
        ...
        step: function (now, fx) {
          ...
          if ("height" !== fx.prop) {
            adjust += fx.now;
          } else if ("content" !== that.options.heightStyle) {
...
(function ($, undefined) {
  ...
  $.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      this._on(this.menu.element, {
        ...
        menufocus: function (event, ui) {
          ...
          !1 !== this._trigger("focus", event, { item: item })
            ? event.originalEvent &&
        ...
        menuselect: function (event, ui) {
          ...
          !1 !== this._trigger("select", event, { item: item }) &&
            this._value(item.value);
    ...
    _appendTo: function () {
      ...
      element || (element = this.element.closest(".ui-front"));
    ...
    _response: function () {
      ...
      return function (content) {
        index === requestIndex && that.__response(content);
        that.pending--;
        that.pending || that.element.removeClass("ui-autocomplete-loading");
      };
    },
...
(function ($, undefined) {
  ...
  $.widget("ui.button", {
      ...
      if (toggleButton) {
        ...
        this.buttonElement
          ...
          .bind("mouseup" + this.eventNamespace, function (event) {
            options.disabled ||
              (startXPos === event.pageX && startYPos === event.pageY) ||
              (clickDragged = !0);
          });
      }
    ...
    _destroy: function () {
      ...
      this.buttonElement
        .removeClass(
          baseClasses + " ui-state-hover ui-state-active  " + typeClasses
        )
        .removeAttr("role")
  ...
  $.extend(Datepicker.prototype, {
    ...
    _optionDatepicker: function (target, name, value) {
      ...
      if (inst) {
        ...
        extendRemove(inst.settings, settings);
        null !== minDate &&
          void 0 !== settings.dateFormat &&
          void 0 === settings.minDate &&
          (inst.settings.minDate = this._formatDate(inst, minDate));
        null !== maxDate &&
          void 0 !== settings.dateFormat &&
          void 0 === settings.maxDate &&
    ...
    _doKeyPress: function (event) {
      ...
      if ($.datepicker._get(inst, "constrainInput")) {
        ...
        chr = String.fromCharCode(
          null == event.charCode ? event.keyCode : event.charCode
        );
        return (
          event.ctrlKey ||
          event.metaKey ||
      ...
      if (
        ...
        if (!1 !== beforeShowSettings) {
          ...
          if (!inst.inline) {
            ...
            $.effects && $.effects.effect[showAnim]
              ? inst.dpDiv.show(
                  showAnim,
    ...
    _updateDatepicker: function (inst) {
      ...
      inst.dpDiv[
        (1 !== numMonths[0] || 1 !== numMonths[1] ? "add" : "remove") + "Class"
      ]("ui-datepicker-multi");
    ...
    parseDate: function (format, value, settings) {
      ...
      var iFormat,
        ...
        shortYearCutoff =
          "string" != typeof shortYearCutoffTemp
            ? shortYearCutoffTemp
    ...
    _get: function (inst, name) {
      return void 0 !== inst.settings[name]
        ? inst.settings[name]
        : this._defaults[name];
    },
    ...
    _generateHTML: function (inst) {
      ...
      for (row = 0; row < numMonths[0]; row++) {
        ...
        for (col = 0; col < numMonths[1]; col++) {
          ...
          numRows =
            isMultiMonth && this.maxRows > curRows ? this.maxRows : curRows;
...
(function ($, undefined) {
  ...
  $.widget("ui.dialog", {
    ...
    _appendTo: function () {
      var element = this.options.appendTo;
      return element && (element.jquery || element.nodeType)
        ? $(element)
        : this.document.find(element || "body").eq(0);
    },
    _destroy: function () {
      var next,
      ...
      next.length && next[0] !== this.element[0]
    ...
    _size: function () {
      ...
      maxContentHeight =
        "number" == typeof options.maxHeight
...
(function ($, undefined) {
  $.widget("ui.draggable", $.ui.mouse, {
    ...
    _mouseStart: function (event) {
      ...
      if (!1 === this._trigger("start", event)) {
        this._clear();
        return !1;
      }
      this._cacheHelperProportions();
    ...
    _mouseStop: function (event) {
      ...
      while (element && (element = element.parentNode)) {
        element === document && (elementInDom = !0);
      }
      if (!elementInDom && "original" === this.options.helper) {
        return !1;
      }
...
(function ($, undefined) {
      ...
      each(hooks, function (i, hook) {
        jQuery.cssHooks[hook] = {
          set: function (elem, value) {
            ...
            if (
              "transparent" !== value &&
              ("string" !== jQuery.type(value) || (parsed = stringParse(value)))
            ) {
  ...
  (function () {
    ...
    function styleDifference(oldStyle, newStyle) {
      ...
      for (name in newStyle) {
        value = newStyle[name];
        oldStyle[name] !== value &&
          (shorthandStyles[name] ||
            (!$.fx.step[name] && isNaN(parseFloat(value))) ||
            (diff[name] = value));
      }
      return diff;
    }
    ...
    $.effects.animateClass = function (value, duration, easing, callback) {
      ...
      return this.queue(function () {
        ...
        allAnimations = allAnimations.map(function () {
          return { el: $(this), start: getElementStyles(this) };
        });
  ...
  (function () {
    ...
    function standardAnimationOption(option) {
      return (
        !(option && "number" != typeof option && !$.fx.speeds[option]) ||
        ("string" == typeof option && !$.effects.effect[option]) ||
        !!$.isFunction(option) ||
        ("object" == typeof option && !option.effect)
      );
    }
    $.extend($.effects, {
      version: "1.10.2",
      ...
      restore: function (element, set) {
        ...
        for (i = 0; i < set.length; i++) {
          if (null !== set[i]) {
            val = element.data("ui-effects-" + set[i]);
            void 0 === val && (val = "");
    ...
    $.fn.extend({
      effect: function () {
        ...
        return $.fx.off || !effectMethod
          ? mode
            ? this[mode](args.duration, args.complete)
            : this.each(function () {
  ...
  (function () {
    ...
    $.each(baseEasings, function (name, easeIn) {
      ...
      $.easing["easeInOut" + name] = function (p) {
        return p < 0.5 ? easeIn(2 * p) / 2 : 1 - easeIn(-2 * p + 2) / 2;
      };
    });
  })();
})(jQuery);
(function ($, undefined) {
  ...
  $.effects.effect.blind = function (o, done) {
    var wrapper,
      ...
      animation = {},
      show = "show" === mode;
    el.parent().is(".ui-effects-wrapper")
...
(function ($, undefined) {
  $.effects.effect.bounce = function (o, done) {
    ...
    distance ||
      (distance = el["top" === ref ? "outerHeight" : "outerWidth"]() / 3);
    if (show) {
      downAnim = { opacity: 1 };
      downAnim[ref] = 0;
      el.css("opacity", 0)
        .css(ref, motion ? 2 * -distance : 2 * distance)
...
(function ($, undefined) {
  $.effects.effect.drop = function (o, done) {
    ...
    $.effects.createWrapper(el);
    distance =
      o.distance || el["top" === ref ? "outerHeight" : "outerWidth"](!0) / 2;
    show &&
...
(function ($, undefined) {
  $.effects.effect.fade = function (o, done) {
    ...
    el.animate(
      { opacity: mode },
      { queue: !1, duration: o.duration, easing: o.easing, complete: done }
    );
  };
})(jQuery);
(function ($, undefined) {
  ...
  $.effects.effect.scale = function (o, done) {
    var el = $(this),
      ...
      percent =
        ...
        (0 === parseInt(o.percent, 10) ? 0 : "hide" === mode ? 0 : 100),
...
(function ($, undefined) {
  $.effects.effect.slide = function (o, done) {
    ...
    el.show();
    distance =
      o.distance || el["top" === ref ? "outerHeight" : "outerWidth"](!0);
  ...
  $.widget("ui.menu", {
    ...
    _create: function () {
      ...
      this._on({
        ...
        blur: function (event) {
          this._delay(function () {
            $.contains(this.element[0], this.document[0].activeElement) ||
    ...
    _keydown: function (event) {
      ...
      switch (event.keyCode) {
        ...
        default:
          ...
          match =
            skip && -1 !== match.index(this.active.next())
    ...
    focus: function (event, item) {
      ...
      nested.length && /^mouse/.test(event.type) && this._startOpening(nested);
      ...
      this.active &&
        (next =
          "first" === direction || "last" === direction
            ? this.active["first" === direction ? "prevAll" : "nextAll"](
                ".ui-menu-item"
              ).eq(-1)
...
(function ($, undefined) {
  ...
  $.widget("ui.resizable", $.ui.mouse, {
    ...
    _mouseCapture: function (event) {
      ...
      for (i in this.handles) {
        ...
        (handle === event.target || $.contains(handle, event.target)) &&
          (capture = !0);
      }
    ...
    _updateRatio: function (data) {
      ...
      isNumber(data.height)
        ...
        : isNumber(data.width) && (data.height = data.width / this.aspectRatio);
      if ("sw" === a) {
    ...
    _respectSize: function (data) {
      ...
      data.width || data.height || data.left || !data.top
        ? data.width ||
          data.height ||
          data.top ||
          !data.left ||
    ...
    _change: {
      ...
      w: function (event, dx) {
        ...
        return { left: this.originalPosition.left + dx, width: cs.width - dx };
      },
      n: function (event, dx, dy) {
        var cs = this.originalSize;
        return { top: this.originalPosition.top + dy, height: cs.height - dy };
      },
  ...
  $.ui.plugin.add("resizable", "containment", {
    ...
    resize: function (event) {
      ...
      woset = Math.abs(
        (that._helper, that.offset.left - cop.left) + that.sizeDiff.width
      );
      hoset = Math.abs(
      ...
      isParent && isOffsetRelative && (woset -= that.parentData.left);
  ...
  $.widget("ui.slider", $.ui.mouse, {
    ...
    _createRange: function () {
      ...
      if (options.range) {
        ...
        this.range.addClass(
          classes +
            ("min" === options.range || "max" === options.range
    ...
    _setOption: function (key, value) {
      var i,
        valsLength = 0;
      if ("range" === key && !0 === this.options.range) {
        if ("min" === value) {
      ...
      if (this.options.values && this.options.values.length) {
        this.handles.each(function (i) {
          valPercent =
            ...
            100;
          _set["horizontal" === that.orientation ? "left" : "bottom"] =
            valPercent + "%";
          $(this).stop(1, 1)[animate ? "animate" : "css"](_set, o.animate);
          if (!0 === that.options.range) {
        ...
        valPercent =
          valueMax !== valueMin
            ...
            : 0;
        _set["horizontal" === this.orientation ? "left" : "bottom"] =
          valPercent + "%";
        ...
        switch (event.keyCode) {
          ...
          case $.ui.keyCode.PAGE_UP:
            newVal = this._trimAlignValue(
              curVal + (this._valueMax() - this._valueMin()) / 5
            );
            break;
          case $.ui.keyCode.PAGE_DOWN:
            newVal = this._trimAlignValue(
...
(function ($, undefined) {
  ...
  $.widget("ui.sortable", $.ui.mouse, {
    ...
    _create: function () {
      ...
      this.floating =
        !!this.items.length &&
        ("x" === o.axis || isFloating(this.items[0].item));
  ...
  $.widget("ui.spinner", {
    ...
    _draw: function () {
      ...
      this.buttons = uiSpinner
        ...
        .button()
        .removeClass("ui-corner-all");
      this.buttons.height() > Math.ceil(0.5 * uiSpinner.height()) &&
        uiSpinner.height() > 0 &&
    ...
    _start: function (event) {
      if (!this.spinning && !1 === this._trigger("start", event)) {
        return !1;
      }
    ...
    _spin: function (step, event) {
      ...
      if (
        !this.spinning ||
        !1 !== this._trigger("spin", event, { value: value })
      ) {
        this._value(value);
        this.counter++;
      }
    ...
    _adjustValue: function (value) {
      ...
      return null !== options.max && value > options.max
        ? options.max
        : null !== options.min && value < options.min
        ? options.min
        : value;
    },
    ...
    _setOption: function (key, value) {
      if ("culture" !== key && "numberFormat" !== key) {
        ("max" !== key && "min" !== key && "step" !== key) ||
          ("string" == typeof value && (value = this._parse(value)));
        if ("icons" === key) {
          this.buttons
            .first()
            .find(".ui-icon")
...
(function ($, undefined) {
  ...
  $.widget("ui.tabs", {
    ...
    _initialActive: function () {
      ...
      !collapsible && !1 === active && this.anchors.length && (active = 0);
      return active;
    },
    _getCreateEventData: function () {
      return {
    ...
    refresh: function () {
      ...
      this._processTabs();
      if (!1 !== options.active && this.anchors.length) {
        if (
          this.active.length &&
    ...
    _setupDisabled: function (disabled) {
      ...
      for (var li, i = 0; (li = this.tabs[i]); i++) {
        !0 === disabled || -1 !== $.inArray(i, disabled)
    ...
    _eventHandler: function (event) {
      ...
      if (
        ...
        options.active = !collapsing && this.tabs.index(tab);
    ...
    disable: function (index) {
      ...
      if (!0 !== disabled) {
        if (void 0 === index) {
          ...
          index = this._getIndex(index);
          if (-1 !== $.inArray(index, disabled)) {
            return;
          }
          disabled = $.isArray(disabled)
            ? $.merge([index], disabled).sort()
            : [index];
        }
        this._setupDisabled(disabled);
      }
...
(function ($) {
  ...
  $.widget("ui.tooltip", {
    ...
    _updateContent: function (target, event) {
      ...
      if ("string" == typeof contentOption) {
...
(function () {
  ...
  var group = function (obj, value, context, behavior) {
    var result = {};
    var iterator = lookupIterator(null == value ? _.identity : value);
...
(function (undefined) {
  ...
  function dateFromArray(config) {
    ...
    if (!config._d) {
      ...
      for (i = 0; i < 3 && null == config._a[i]; ++i) {
  ...
  function makeDateFromStringAndFormat(config) {
    ...
    for (i = 0; i < tokens.length; i++) {
      parsedInput = (getParseRegexForToken(tokens[i], config).exec(string) ||
        [])[0];
      parsedInput &&
        (string = string.slice(
          string.indexOf(parsedInput) + parsedInput.length
        ));
      formatTokenFunctions[tokens[i]] &&
        addTimeToArrayFromToken(tokens[i], parsedInput, config);
    }
    string && (config._il = string);
    config._isPm && config._a[3] < 12 && (config._a[3] += 12);
    !1 === config._isPm && 12 === config._a[3] && (config._a[3] = 0);
  ...
  function weekOfYear(mom, firstDayOfWeek, firstDayOfWeekOfYear) {
    ...
    daysToDayOfWeek < end - 7 && (daysToDayOfWeek += 7);
  ...
  moment.lang = function (key, values) {
    ...
    if (values) {
      ...
      languages[key] || getLangDefinition(key);
    }
  ...
  extend((moment.fn = Moment.prototype), {
    ...
    invalidAt: function () {
      var i,
        arr1 = this._a,
        arr2 = (this._isUTC ? moment.utc(this._a) : moment(this._a)).toArray();
    ...
    add: function (input, val) {
      ...
      dur =
        "string" == typeof input
          ? moment.duration(+val, input)
          : moment.duration(input, val);
    ...
    diff: function (input, units, asFloat) {
      var diff,
        output,
        that = this._isUTC
          ? moment(input).zone(this._offset || 0)
          : moment(input).local(),
      ...
      if ("year" === units || "month" === units) {
        ...
        output =
          12 * (this.year() - that.year()) + (this.month() - that.month());
        output +=
          (this -
    ...
    endOf: function (units) {
      ...
      return this.startOf(units)
        .add("isoweek" === units ? "week" : units, 1)
        .subtract("ms", 1);
    },
    isAfter: function (input, units) {
      units = void 0 !== units ? units : "millisecond";
...
(function (root, define, factory) {
  ...
  "function" == typeof define && define.amd
    ? define(function (req) {
        var moment =
          req.defined && req.defined("moment") ? req("moment") : void 0;
        return factory(moment || root.moment);
      })
    : (root.Pikaday = factory(root.moment));
})(window, window.define, function (moment) {
  "use strict";
  var hasMoment = "function" == typeof moment,
    ...
    extend = function (to, from, overwrite) {
      var prop, hasProp;
      for (prop in from) {
        hasProp = void 0 !== to[prop];
        hasProp &&
        "object" == typeof from[prop] &&
        void 0 === from[prop].nodeName
          ? isDate(from[prop])
            ? overwrite && (to[prop] = new Date(from[prop].getTime()))
            : isArray(from[prop])
            ? overwrite && (to[prop] = from[prop].slice(0))
            : (to[prop] = extend({}, from[prop], overwrite))
          : (!overwrite && hasProp) || (to[prop] = from[prop]);
      }
      return to;
    },
    defaults = {
    ...
    renderDay = function (i, isSelected, isToday, isDisabled, isEmpty) {
      ...
      var arr = [];
      isDisabled && arr.push("is-disabled");
      isToday && arr.push("is-today");
      isSelected && arr.push("is-selected");
      return (
        '<td data-day="' +
        i +
        '" class="' +
    ...
    renderTitle = function (instance) {
      ...
      html +=
        ...
        arr.join("") +
        "</select></div>";
      isMinYear && (0 === month || opts.minMonth >= month) && (prev = !1);
      isMaxYear && (11 === month || opts.maxMonth <= month) && (next = !1);
      html +=
    ...
    Pikaday = function (options) {
          ...
          if (target) {
            if (!hasClass(target, "is-disabled")) {
              if (
                ...
                self.setDate(
                  new Date(self._y, self._m, parseInt(target.innerHTML, 10))
                );
                opts.bound &&
                  sto(function () {
                    self.hide();
              ...
              hasClass(target, "pika-prev")
                ? self.prevMonth()
                : hasClass(target, "pika-next") && self.nextMonth();
            }
      ...
      self._onChange = function (e) {
        ...
        var target = e.target || e.srcElement;
        target &&
          (hasClass(target, "pika-select-month")
            ? self.gotoMonth(target.value)
            : hasClass(target, "pika-select-year") &&
  ...
  Pikaday.prototype = {
    config: function (options) {
      ...
      isDate(opts.minDate) || (opts.minDate = !1);
      isDate(opts.maxDate) || (opts.maxDate = !1);
      opts.minDate &&
        opts.maxDate &&
    ...
    draw: function (force) {
      if (this._v || force) {
        ...
        if (this._y <= minYear) {
          this._y = minYear;
          !isNaN(minMonth) && this._m < minMonth && (this._m = minMonth);
        }
        if (this._y >= maxYear) {
          this._y = maxYear;
          !isNaN(maxMonth) && this._m > maxMonth && (this._m = maxMonth);
        }
        this.el.innerHTML = renderTitle(this) + this.render(this._y, this._m);
        if (opts.bound) {
          this.adjustPosition();
          "hidden" !== opts.field.type &&
            sto(function () {
              opts.trigger.focus();
            }, 1);
        }
    ...
    adjustPosition: function () {
      ...
      left + width > viewportWidth && (left = left - width + field.offsetWidth);
    ...
    render: function (year, month) {
      ...
      for (var i = 0, r = 0; i < cells; i++) {
        var day = new Date(year, month, i - before + 1),
          ...
          isSelected = !!isDate(this._d) && compareDates(day, this._d),
          isToday = compareDates(day, now),
          isEmpty = i < before || i >= days + before;
        row.push(
          renderDay(i - before + 1, isSelected, isToday, isDisabled, isEmpty)
        );
        if (7 == ++r) {
    ...
    show: function () {
      if (!this._v) {
        this._o.bound && addEvent(document, "click", this._onClick);
    ...
    hide: function () {
      var v = this._v;
      if (!1 !== v) {
        this._o.bound && removeEvent(document, "click", this._onClick);
        this.el.style.cssText = "";
