...
var getCustomRequestInfo = function getCustomRequestInfo(
  url,
  options,
  payload
) {
  ...
  _createClass(I18NextLocizeBackend, [
    {
      ...
      value: function init(services) {
        ...
        if (
          ...
          passedOpt.reloadInterval < 5 * 60 * 1000
        ) {
    ...
    },
    {
      ...
      value: function read(language, namespace, callback) {
        ...
        if (this.isProjectNotExisting) {
          var err = new Error(
            "locize project ".concat(this.options.projectId, " does not exist!")
          );
          if (logger) logger.error(err.message);
          if (callback) callback(err);
          return;
    ...
    },
    {
      ...
      value: function loadUrl(options, url, payload, callback) {
        ...
        if (
          ...
          return request(options, url, payload, clb);
