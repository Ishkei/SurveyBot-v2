...
(function (factory, root) {
  ...
  rangy.createModule("TextRange", ["WrappedSelection"], function (api, module) {
    ...
    extend(nodeProto, {
      ...
      isWhitespace: createCachingGetter(
        "isWhitespace",
        isWhitespaceNode,
        "node"
      ),
    ...
    function inspectPosition() {
      return (
        "[Position(" + dom.inspectNode(this.node) + ":" + this.offset + ")]"
      );
    }
    ...
    function createRangeBoundaryMover(isStart, collapse) {
      ...
      return createEntryPointFunction(function (
        ...
        this[boundaryIsStart ? "setStart" : "setEnd"](
          newPos.node,
          newPos.offset
        );
    ...
    extend(api.rangePrototype, {
      ...
      expand: createEntryPointFunction(function (session, unit, expandOptions) {
        var moved = false;
        expandOptions = createNestedOptions(
          expandOptions,
      ...
      findText: createEntryPointFunction(function (
        ...
        if (comparison === -1) {
          ...
          initialPos = session.getRangeBoundaryPosition(
            searchScopeRange,
            false
          );
        }
    ...
    api.createWordIterator = function (
      startNode,
      startOffset,
      iteratorOptions
    ) {
    ...
    api.textRange = {
      ...
      createPosition: createEntryPointFunction(function (
        session,
        node,
        offset
      ) {
