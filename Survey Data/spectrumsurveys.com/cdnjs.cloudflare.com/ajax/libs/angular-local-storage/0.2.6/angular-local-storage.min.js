...
!(function (a, b) {
  var c = b.isDefined,
    ...
    h = b.extend,
    i = b.toJson;
  b.module("LocalStorageModule", []).provider(
    "localStorageService",
    function () {
      (this.prefix = "ls"),
            ...
            var r = function (a) {
              ...
              s = (function () {
                try {
                  ...
                  return (
                    c && ((l = b[q]), l.setItem(d, ""), l.removeItem(d)), c
                  );
                } catch (e) {
                  return (
                    (q = "cookie"),
              ...
              t = function (b, c) {
                if (
                  ((c = d(c) ? null : i(c)), !s || "cookie" === m.storageType)
                )
                  return (
                    s ||
                      a.$broadcast(
              ...
              v = function () {
                ...
                for (b = 0; b < arguments.length; b++)
                  if (((c = arguments[b]), s && "cookie" !== m.storageType))
                    try {
                      l.removeItem(r(c)),
                        p.removeItem &&
                          a.$broadcast(
                            "LocalStorageModule.notification.removeitem",
                            { key: c, storageType: m.storageType }
                          );
                    } catch (d) {
                      a.$broadcast(
                        "LocalStorageModule.notification.error",
              ...
              y = (function () {
                try {
                  return (
                    ...
                    ("cookie" in j &&
                      (j.cookie.length > 0 ||
                        (j.cookie = "test").indexOf.call(j.cookie, "test") >
                          -1))
                  );
                } catch (c) {
                  return (
                  ...
                  if (
                    (null === c
                      ? (l.setTime(l.getTime() + -864e5),
                        ...
                        (c = ""))
                      : e(h) && 0 !== h
                      ? (l.setTime(l.getTime() + 24 * h * 60 * 60 * 1e3),
                        (k = "; expires=" + l.toGMTString()))
                      : 0 !== o.expiry &&
                        (l.setTime(l.getTime() + 24 * o.expiry * 60 * 60 * 1e3),
                        (k = "; expires=" + l.toGMTString())),
                    b)
                  ) {
                    var n = "; path=" + o.path;
                    o.domain && (m = "; domain=" + o.domain),
                      (j.cookie =
                        r(b) + "=" + encodeURIComponent(c) + k + n + m);
                  }
                } catch (p) {
                  return (
                    a.$broadcast(
              ...
              A = function (b) {
                ...
                for (
                  var c = (j.cookie && j.cookie.split(";")) || [], d = 0;
                  d < c.length;
                  d++
                ) {
                  ...
                  if (0 === e.indexOf(r(b) + "=")) {
                    var f = decodeURIComponent(
                      e.substring(n.length + b.length + 1, e.length)
                    );
                    try {
                      return JSON.parse(f);
                    } catch (g) {
              ...
              C = function () {
                for (
                  var a = null, b = n.length, c = j.cookie.split(";"), d = 0;
                  d < c.length;
                  d++
                ) {
              ...
              E = function (a, b, d, e) {
                ...
                var g = u(e);
                return (
                  null === g && c(d) ? (g = d) : f(g) && f(d) && (g = h(g, d)),
                  k(b).assign(a, g),
                  a.$watch(
                    b,
                    function (a) {
