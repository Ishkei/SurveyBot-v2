    ...
    66775: function (t, e, i) {
      ...
      function N(t, e) {
        ...
        if (a > 0) {
          ...
          for (
            W(e, l, c, (0, s.k)(n) ? 0 : r - n, r), t = 0, i = a - 1;
            t < i;
            t++
          )
            W(e, l, c, o[t], o[t + 1]);
          return W(e, l, c, h, (0, s.k)(n) ? e.length : h + n), l;
        }
        return W(e, l, c), l;
      }
          ...
          const {
            ...
            if (t.isHorizontal()) {
              if (((g = (0, s.S)(n, a, h)), (0, s.i)(i))) {
                ...
                p =
                  "center" === i ? (c.bottom + c.top) / 2 + m - e : H(t, i, e);
              u = h - a;
            } else {
              if ((0, s.i)(i)) {
                const t = Object.keys(i)[0],
                ...
                g =
                  "center" === i ? (c.left + c.right) / 2 - x + e : H(t, i, e);
      ...
      var rt = {
        evaluateInteractionItems: it,
        modes: {
          index(t, e, i, n) {
            const o = (0, s.X)(e, t),
              a = i.axis || "x",
              r = i.includeInvisible || !1,
              h = i.intersect ? st(t, o, a, n, r) : ot(t, o, a, !1, n, r),
              l = [];
            return h.length
          ...
          dataset(t, e, i, n) {
            const o = (0, s.X)(e, t),
              a = i.axis || "xy",
              r = i.includeInvisible || !1;
            let h = i.intersect ? st(t, o, a, n, r) : ot(t, o, a, !1, n, r);
            if (h.length > 0) {
          ...
          point: (t, e, i, n) =>
            st(t, (0, s.X)(e, t), i.axis || "xy", n, i.includeInvisible || !1),
          nearest(t, e, i, n) {
            const o = (0, s.X)(e, t),
              a = i.axis || "xy",
              r = i.includeInvisible || !1;
            return ot(t, o, a, i.intersect, n, r);
          },
          x: (t, e, i, n) => at(t, (0, s.X)(e, t), "x", i.intersect, n),
          y: (t, e, i, n) => at(t, (0, s.X)(e, t), "y", i.intersect, n),
        },
      };
      const ht = ["left", "top", "right", "bottom"];
      function lt(t, e) {
        return t.filter((t) => t.pos === e);
      }
      function ct(t, e) {
        return t.filter((t) => -1 === ht.indexOf(t.pos) && t.box.axis === e);
      }
      function dt(t, e) {
        return t.sort((t, i) => {
          const s = e ? i : t,
      ...
      function ft(t, e, i, n) {
        ...
        a.getPadding && pt(r, a.getPadding());
        const h = Math.max(0, e.outerWidth - gt(r, t, "left", "right")),
          l = Math.max(0, e.outerHeight - gt(r, t, "top", "bottom")),
          c = h !== t.w,
          d = l !== t.h;
        return (
          (t.w = h),
      ...
      function xt(t, e, i, s) {
        ...
        for (o = 0, a = t.length, l = 0; o < a; ++o) {
          (r = t[o]),
            (h = r.box),
            h.update(r.width || e.w, r.height || e.h, mt(r.horizontal, e));
          const { same: a, other: d } = ft(e, i, r, s);
          (l |= a && n.length), (c = c || d), h.fullSize || n.push(r);
        }
        return (l && xt(n, e, i, s)) || c;
      }
        ...
        for (const h of t) {
          ...
          if (h.horizontal) {
            ...
            (0, s.j)(l.start) && (r = l.start),
              t.fullSize
                ? bt(t, o.left, r, i.outerWidth - o.right - o.left, a)
                : bt(t, e.left + l.placed, r, n, a),
              (l.start = r),
              (l.placed += n),
              (r = t.bottom);
          } else {
            ...
            (0, s.j)(l.start) && (a = l.start),
              t.fullSize
                ? bt(t, a, o.top, r, i.outerHeight - o.bottom - o.top)
                : bt(t, a, e.top + l.placed, r, n),
              (l.start = a),
              (l.placed += n),
              (a = t.right);
          }
      ...
      var vt = {
        ...
        update(t, e, i, n) {
          ...
          xt(h.fullSize, p, u, f),
            ...
            _t(h.leftAndTop, p, u, f),
            (p.x += p.w),
            (p.y += p.h),
            _t(h.rightAndBottom, p, u, f),
            (t.chartArea = {
              left: p.left,
              top: p.top,
              right: p.left + p.w,
      ...
      const kt = {
        ...
        wt = (t) => null === t || "" === t;
      const St = !!s.a5 && { passive: !0 };
      function Dt(t, e, i) {
        t.canvas.removeEventListener(e, i, St);
      }
      function Pt(t, e) {
      ...
      function Ct(t, e, i) {
        const s = t.canvas,
          n = new MutationObserver((t) => {
            let e = !1;
            for (const i of t)
              (e = e || Pt(i.addedNodes, s)), (e = e && !Pt(i.removedNodes, s));
            e && i();
          });
      ...
      function At(t, e, i) {
        const s = t.canvas,
          n = new MutationObserver((t) => {
            let e = !1;
            for (const i of t)
              (e = e || Pt(i.removedNodes, s)), (e = e && !Pt(i.addedNodes, s));
            e && i();
          });
        return n.observe(document, { childList: !0, subtree: !0 }), n;
      }
      ...
      function Tt(t, e, i) {
        ...
        return (
          r.observe(o),
          (function (t, e) {
            Ot.size || window.addEventListener("resize", Et), Ot.set(t, e);
          })(t, a),
          r
        );
      }
      function Rt(t, e, i) {
        i && i.disconnect(),
          "resize" === e &&
            (function (t) {
              Ot.delete(t), Ot.size || window.removeEventListener("resize", Et);
            })(t);
      }
      function zt(t, e, i) {
        const n = t.canvas,
      ...
      class It extends yt {
        ...
        addEventListener(t, e, i) {
          ...
          const s = t.$proxies || (t.$proxies = {}),
            n = { attach: Ct, detach: At, resize: Tt }[e] || zt;
          s[e] = n(t, e, i);
        }
        removeEventListener(t, e) {
          const i = t.$proxies || (t.$proxies = {}),
            s = i[e];
          if (!s) return;
          (({ attach: Rt, detach: Rt, resize: Rt }[e] || Dt)(t, e, s),
            (i[e] = void 0));
        }
        getDevicePixelRatio() {
            ...
            ? (function (t, { plugins: e, localIds: i }, s, n) {
                ...
                for (const r of e) {
                  ...
                  null !== h &&
                    o.push({
                      plugin: r,
                      options: Bt(t.config, { plugin: r, local: i[e] }, h, a),
                    });
                }
                return o;
              })(t, o, n, e)
      ...
      function Bt(t, { plugin: e, local: i }, s, n) {
      ...
      function Yt(t, e) {
        let i = $t.get(t);
        return i || ((i = e()), $t.set(t, i), Ut.add(i)), i;
      }
      const Kt = (t, e, i) => {
        const n = (0, s.f)(e, i);
        void 0 !== n && t.add(n);
      ...
      class Xt {
        constructor(t) {
          (this._config = (function (t) {
            return ((t = t || {}).data = jt(t.data)), Ht(t), t;
          })(t)),
        ...
        update() {
          ...
          this.clearCache(), Ht(t);
        }
        clearCache() {
          this._scopeCache.clear(), this._resolverCache.clear();
        }
        datasetScopeKeys(t) {
          return Yt(t, () => [[`datasets.${t}`, ""]]);
        }
        datasetAnimationScopeKeys(t, e) {
          return Yt(`${t}.transition.${e}`, () => [
        ...
        getOptionScopes(t, e, i) {
          ...
          const h = new Set();
          e.forEach((e) => {
            t && (h.add(t), e.forEach((e) => Kt(h, t, e))),
              e.forEach((t) => Kt(h, n, t)),
              e.forEach((t) => Kt(h, s.U[o] || {}, t)),
              e.forEach((t) => Kt(h, s.d, t)),
              e.forEach((t) => Kt(h, s.a7, t));
          });
      ...
      class ae {
        constructor(t, e) {
          ...
          (this.id = (0, s.ad)()),
            ...
            (se[this.id] = this),
            h && l
              ? (n.listen(this, "complete", te),
                n.listen(this, "progress", ee),
                this._initialize(),
        ...
        buildOrUpdateScales() {
          ...
          e &&
            ...
            (0, s.Q)(o, (e) => {
              ...
              (void 0 !== o.position &&
                Jt(o.position, r) === Jt(e.dposition)) ||
            ...
            (0, s.Q)(i, (t) => {
              vt.configure(this, t, t.options), vt.addBox(this, t);
            });
        }
        _updateMetasets() {
          ...
          this._sortedMetasets = t.slice(0).sort(Zt("order", "index"));
        }
        ...
        buildOrUpdateControllers() {
          ...
          for (
            ...
            if (
              ...
              (o.type = a),
              (o.indexAxis = n.indexAxis || Nt(a, this.options)),
              (o.order = n.order || 0),
              (o.index = i),
              (o.label = "" + n.label),
      ...
      const re = () => (0, s.Q)(ae.instances, (t) => t._plugins.invalidate()),
        he = !0;
      function le(t, e, i) {
        const {
          startAngle: n,
      ...
      Object.defineProperties(ae, {
        defaults: { enumerable: he, value: s.d },
        instances: { enumerable: he, value: se },
        overrides: { enumerable: he, value: s.U },
        registry: { enumerable: he, value: G },
        version: { enumerable: he, value: "3.9.1" },
        getChart: { enumerable: he, value: ne },
        register: {
          enumerable: he,
          value: (...t) => {
            G.add(...t), re();
      ...
      class pe extends F {
        ...
        draw(t) {
          ...
          const h = (function (t, e, i, n, o) {
            ...
            return ue(t, e, i, n, l, o), t.fill(), l;
          })(t, this, r, o, a);
          ge(t, this, r, o, h, a), t.restore();
        }
      }
      function fe(t, e, i = e) {
      ...
      function be(t, e, i, n) {
        const { points: o, options: a } = e,
          { count: r, start: h, loop: l, ilen: c } = xe(o, i, n),
          d = (function (t) {
            return t.stepped
              ? s.as
      ...
      (pe.id = "arc"),
        ...
        (pe.defaultRoutes = { backgroundColor: "backgroundColor" });
      const ye = "function" === typeof Path2D;
      function Me(t, e, i, s) {
        ye && !e.options.segment
          ? (function (t, e, i, s) {
              let n = e._path;
              n ||
      ...
      class ke extends F {
        ...
        draw(t, e, i, s) {
          ...
          (this.points || []).length &&
            n.borderWidth &&
            (t.save(), Me(t, this, i, s), t.restore()),
            this.animated &&
      ...
      class Se extends F {
        ...
        inXRange(t, e) {
          return we(this, t, "x", e);
        }
        inYRange(t, e) {
          return we(this, t, "y", e);
        }
        getCenterPoint(t) {
          const { x: e, y: i } = this.getProps(["x", "y"], t);
          return { x: e, y: i };
        ...
        const e = De(t),
          ...
          o = (function (t, e, i) {
            const n = t.options.borderWidth,
              ...
              a = (0, s.aw)(n);
            return {
              t: Pe(o.top, a.top, 0, i),
              r: Pe(o.right, a.right, 0, e),
              b: Pe(o.bottom, a.bottom, 0, i),
              l: Pe(o.left, a.left, 0, e),
            };
          })(t, i / 2, n / 2),
          a = (function (t, e, i) {
            const { enableBorderRadius: n } = t.getProps([
              ...
              l = n || (0, s.i)(o);
            return {
              topLeft: Pe(!l || h.top || h.left, a.topLeft, 0, r),
              topRight: Pe(!l || h.top || h.right, a.topRight, 0, r),
              bottomLeft: Pe(!l || h.bottom || h.left, a.bottomLeft, 0, r),
              bottomRight: Pe(!l || h.bottom || h.right, a.bottomRight, 0, r),
            };
          })(t, i / 2, n / 2);
        return {
      ...
      class Re extends F {
        ...
        fit() {
          ...
          const i = t.labels,
            ...
            { boxWidth: r, itemHeight: h } = Te(i, o);
          let l, c;
          (e.font = n.string),
            this.isHorizontal()
        ...
        _draw() {
          ...
          this.drawTitle(),
            ...
            (n.lineWidth = 0.5),
            (n.font = l.string);
          const { boxWidth: f, boxHeight: m, itemHeight: x } = Te(a, u),
            b = this.isHorizontal(),
      ...
      var ze = {
        ...
        _element: Re,
        start(t, e, i) {
          const s = (t.legend = new Re({ ctx: t.ctx, options: i, chart: t }));
          vt.configure(t, s, i), vt.addBox(t, s);
        },
        stop(t) {
        ...
        beforeUpdate(t, e, i) {
          const s = t.legend;
          vt.configure(t, s, i), (s.options = i);
        },
        afterUpdate(t) {
          const e = t.legend;
      ...
      function He(t, e, i) {
        ...
        return { xAlign: i.xAlign || e.xAlign || We(t, e, i, s), yAlign: s };
      }
      function je(t, e, i, n) {
      ...
      class Ke extends F {
        ...
        getTitle(t, e) {
          ...
          let a = [];
          return (a = Fe(a, Ve(s))), (a = Fe(a, Ve(n))), (a = Fe(a, Ve(o))), a;
        }
        getBeforeBody(t, e) {
          return Ue(e.callbacks.beforeBody.apply(this, [t]));
        }
        getBody(t, e) {
          const { callbacks: i } = e,
            n = [];
          return (
            (0, s.Q)(t, (t) => {
              const e = { before: [], lines: [], after: [] },
                s = Ye(i, t);
              Fe(e.before, Ve(s.beforeLabel.call(this, t))),
                Fe(e.lines, s.label.call(this, t)),
                Fe(e.after, Ve(s.afterLabel.call(this, t))),
                n.push(e);
            }),
            n
          );
        ...
        getAfterBody(t, e) {
          return Ue(e.callbacks.afterBody.apply(this, [t]));
        }
        getFooter(t, e) {
          const { callbacks: i } = e,
        ...
        _createItems(t) {
          ...
          let r,
            h,
            l = [];
          for (r = 0, h = e.length; r < h; ++r) l.push(Be(this.chart, e[r]));
          return (
        ...
        update(t, e) {
          ...
          let n,
            o = [];
          if (s.length) {
            const t = Ie[i.position].call(this, s, this._eventPosition);
            ...
            const e = (this._size = Ne(this, i)),
              a = Object.assign({}, t, e),
              r = He(this.chart, i, a),
              h = je(i, a, r, this.chart);
        ...
        _updateAnimationTarget(t) {
          const e = this.chart,
            ...
            n = i && i.y;
          if (s || n) {
            const i = Ie[t.position].call(
              this,
              this._active,
              this._eventPosition
            );
            if (!i) return;
            const o = (this._size = Ne(this, t)),
      ...
      var Xe = {
        ...
        positioners: Ie,
        afterInit(t, e, i) {
          i && (t.tooltip = new Ke({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
        ...
        parse(t, e) {
          ...
          return ((t, e) =>
            ...
            (e =
              isFinite(e) && i[e] === t
                ? e
                : Qe(i, t, (0, s.v)(e, t), this._addedLabels)),
            i.length - 1
          );
        }
        determineDataLimits() {
      ...
      function qe(t, e, { horizontal: i, minRotation: n }) {
        const o = (0, s.t)(n),
      ...
      (Ge.id = "category"),
        (Ge.defaults = { ticks: { callback: Ge.prototype.getLabelForValue } });
      class Je extends X {
        constructor(t) {
          super(t),
            (this.start = void 0),
          ...
          const n = (function (t, e) {
            ...
            for (
              ...
              (u && M !== a
                ? (i.push({ value: a }),
                  M < a && P++,
                  (0, s.aK)(Math.round((M + P * S) * y) / y, a, qe(a, v, t)) &&
                    P++)
                : M < a && P++);
              P < w;
              ++P
            ...
            return (
              b && u && k !== r
                ? i.length && (0, s.aK)(i[i.length - 1].value, r, qe(r, v, t))
      ...
      (Ze.id = "linear"),
        (Ze.defaults = { ticks: { callback: B.formatters.numeric } });
      class ei extends X {
        constructor(t) {
          super(t),
            (this.start = void 0),
        ...
        parse(t, e) {
          const i = Je.prototype.parse.apply(this, [t, e]);
      ...
      function ni(t) {
        ...
        for (let u = 0; u < a; u++) {
          ...
          oi(i, e, m, si(x, g.x, f.w, 0, 180), si(x, g.y, f.h, 90, 270));
        }
        var l, c, d;
      ...
      class ci extends Je {
        ...
        setDimensions() {
          const t = (this._padding = (0, s.K)(ii(this.options) / 2)),
      ...
      (ci.id = "radialLinear"),
        ...
        (ci.descriptors = { angleLines: { _fallback: "grid" } });
      const di = {
      ...
      function fi(t, e, i, s) {
        const n = ui.length;
        for (let o = ui.indexOf(t); o < n - 1; ++o) {
          const t = di[ui[o]],
            n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
          if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return ui[o];
        }
        return ui[n - 1];
      }
      function mi(t, e, i) {
      ...
      class bi extends X {
        ...
        init(t, e) {
          const i = t.time || (t.time = {}),
            n = (this._adapter = new tt._date(t.adapters.date));
          n.init(e),
        ...
        parse(t, e) {
          return void 0 === t ? null : pi(this, t);
        }
        beforeLayout() {
          super.beforeLayout(),
            (this._cache = { data: [], labels: [], all: [] });
        ...
        buildTicks() {
          ...
          return (
            (this._unit =
              e.unit ||
              (i.autoSkip
                ? fi(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
                : (function (t, e, i, s, n) {
                    for (let o = ui.length - 1; o >= ui.indexOf(i); o--) {
                      const i = ui[o];
                      if (di[i].common && t._adapter.diff(n, s, i) >= e - 1)
                        return i;
                    }
                    return ui[i ? ui.indexOf(i) : 0];
                  })(this, r.length, e.minUnit, this.min, this.max))),
            (this._majorUnit =
              i.major.enabled && "year" !== this._unit
                ? (function (t) {
                    for (let e = ui.indexOf(t) + 1, i = ui.length; e < i; ++e)
                      if (di[ui[e]].common) return ui[e];
                  })(this._unit)
                : void 0),
            this.initOffsets(n),
            t.reverse && r.reverse(),
            xi(this, r, this._majorUnit)
          );
        }
        afterAutoSkip() {
        ...
        _generate() {
          const t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            a = o.unit || fi(o.minUnit, e, i, this._getLabelCapacity(e)),
          ...
          for (d = g, u = 0; d < i; d = +t.add(d, r, a), u++) mi(c, d, p);
          return (
            (d !== i && "ticks" !== n.bounds && 1 !== u) || mi(c, d, p),
            Object.keys(c)
              .sort((t, e) => t - e)
              .map((t) => +t)
          );
        ...
        getLabelTimestamps() {
          ...
          for (e = 0, i = s.length; e < i; ++e) t.push(pi(this, s[e]));
          return (this._cache.labels = this._normalized
            ? t
            : this.normalize(t));
        }
        normalize(t) {
          return (0, s._)(t.sort(gi));
        }
      }
      function _i(t, e, i) {
        let n,
      ...
      class vi extends bi {
        ...
        initOffsets() {
          ...
          (this._minPos = _i(e, this.min)),
            (this._tableRange = _i(e, this.max) - this._minPos),
            super.initOffsets(t);
        }
        buildLookupTable(t) {
        ...
        getDecimalForValue(t) {
          return (_i(this._table, t) - this._minPos) / this._tableRange;
        }
        getValueForPixel(t) {
          const e = this._offsets,
            i = this.getDecimalForPixel(t) / e.factor - e.end;
      ...
      (vi.id = "timeseries"), (vi.defaults = bi.defaults);
    },
  },
]);
//# sourceMappingURL=3fff1979-e869091e42beff9c.js.map
